...
class Streamer(object):
    ...
    def __init__(self, mh, event, packets, request):
        self.mh=mh
...
def open_cb(opaque, datap, length):
    ...
    self.s1=Streamer(self, self.ad_event1, self.buffer1, self.request)
    self.ad_event2=threading.Event()
    self.buffer2=Queue.Queue()
    self.s2=Streamer(self, self.ad_event2, self.buffer2, self.request)
